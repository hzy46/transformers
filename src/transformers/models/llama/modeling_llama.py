...
class LlamaFlashAttention2(LlamaAttention):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.layer_idx == 0:
            print("initial query_states shape", query_states.shape, "key_states shape", key_states.shape)
        ...
        if self.layer_idx == 0:
            print("pre-attn query_states shape", query_states.shape, "key_states shape", key_states.shape)
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        only_front_n_layer=None,  # 只跑前几层，只为了检测 purpose
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        for decoder_layer in self.layers[: self.config.num_hidden_layers]:
            ...
            layer_count += 1
            if only_front_n_layer is not None and layer_count == only_front_n_layer:
                break
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        outputs = self.model(
            ...
            cache_position=cache_position,
            only_front_n_layer=only_front_n_layer,
            **kwargs,
        )
